...
urlpatterns = [
    ...
    path('product-detail/<int:pk>/', ProductDetailsView.as_view(), name='product-detail'),
    ...
    path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.
         as_view(template_name='app/password_reset_confirm.html',form_class=MySetPasswordFrom), name='password_reset_confirm'),
